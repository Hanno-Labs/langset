...
class TrainingArguments:
    ...
    # 33.3% across no-neg/0.3/1.0/fixed), `label_neg_field` operates DIRECTLY on the reserved-digit softmax (dim_lg).
    ...
    lam_label_neg: float = 0.0
    label_neg_field: Optional[str] = None
